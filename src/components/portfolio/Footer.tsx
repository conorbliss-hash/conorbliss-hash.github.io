        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
            <a 
              ...
              onClick={() => trackEvent("Outbound Click", { destination: "footer-github" })}
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => trackEvent("Outbound Click", { destination: "footer-linkedin" })}
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => trackEvent("Outbound Click", { destination: "footer-medium" })}
            >
